...
void ModuleExercice3::createVertexBuffer()
{
	struct Vertex
	{
		float x, y, z;
...
bool ModuleExercice3::createRootSignature()
{
...
void ModuleExercice3::createPSO()
{
...
Matrix ModuleExercice3::createModelMatrix()
{
